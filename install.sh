#!/bin/sh
# CEOadmin Hub installer
# Usage: curl -fsSL https://raw.githubusercontent.com/ceoadmin/CEOadmin/main/install.sh | sh
set -e

REPO="ceoadmin/CEOadmin"
BINARY="oih"
...
detect_os() {
    ...
    docker run -d -p 9800:9800 ceoadmin/CEOadmin:latest
See ${REPO}#windows for details." ;;
...
main() {
  ...
  docker run -d -p 9800:9800 ghcr.io/ceoadmin/CEOadmin:latest"
    fi
    ...
    ARCHIVE="CEOadmin_${VERSION_NUM}_${OS}_${ARCH}.tar.gz"
