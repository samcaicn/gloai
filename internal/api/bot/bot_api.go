...
func (s *BotHandler) HandleBotAPISend(w http.ResponseWriter, r *http.Request) {
...
func (s *BotHandler) HandleBotAPIContacts(w http.ResponseWriter, r *http.Request) {
	inst := installationFromContext(r.Context())
	if inst == nil {
		botAPIError(w, "unauthorized", http.StatusUnauthorized)
		return
...
func (s *BotHandler) HandleBotAPIBotInfo(w http.ResponseWriter, r *http.Request) {
	inst := installationFromContext(r.Context())
	if inst == nil {
		botAPIError(w, "unauthorized", http.StatusUnauthorized)
		return
...
func (s *BotHandler) HandleBotAPINotFound(w http.ResponseWriter, r *http.Request) {
...
func (s *BotHandler) HandleBotAPIUpdateTools(w http.ResponseWriter, r *http.Request) {
	inst := installationFromContext(r.Context())
	if inst == nil {
		botAPIError(w, "unauthorized", http.StatusUnauthorized)
		return
...
func (s *BotHandler) HandleBotAPIUpdateInstallationTools(w http.ResponseWriter, r *http.Request) {
	inst := installationFromContext(r.Context())
	if inst == nil {
		botAPIError(w, "unauthorized", http.StatusUnauthorized)
		return
...
// shared.SSRFSafeDialContext returns a DialContext that rejects connections to private IPs.
...
var safeHTTPClient = &http.Client{
	...
	Transport: &http.Transport{
		DialContext: shared.SSRFSafeDialContext,
	},
