...
func (s *MediaHandler) HandleChannelMedia(w http.ResponseWriter, r *http.Request) {
	...
	if ch, _ := shared.AuthenticateChannel(s.Store, r); ch != nil {
...
func (s *MediaHandler) serveChannelMedia(w http.ResponseWriter, r *http.Request, inst *bot.Instance, eqp, aes string) {
...
func (s *MediaHandler) HandleMediaProxy(w http.ResponseWriter, r *http.Request) {
	...
	if !authed {
		if ch, _ := shared.AuthenticateChannel(s.Store, r); ch != nil && ch.BotID == botID {
			authed = true
		}
	}
