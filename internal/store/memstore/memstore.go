...
func (s *Store) UpdateBotCredentials(id, providerID string, credentials json.RawMessage) error     { return nil }
...
func (s *Store) SaveMessage(m *store.Message) (store.SaveResult, error)                        { return store.SaveResult{}, nil }
func (s *Store) GetMessage(id int64) (*store.Message, error)                                   { return nil, nil }
func (s *Store) ListMessages(botID string, limit int, beforeID int64) ([]store.Message, error) { return nil, nil }
func (s *Store) ListChannelMessages(channelID, sender string, limit int) ([]store.Message, error) {
	return nil, nil
}
func (s *Store) ListMessagesBySender(botID, sender string, limit int) ([]store.Message, error) { return nil, nil }
...
func (s *Store) GetUnprocessedMessages(botID string, limit int) ([]store.Message, error)      { return nil, nil }
...
func (s *Store) UpdateMediaStatusByID(id int64, status string, keys json.RawMessage) error              { return nil }
...
func (s *Store) GetInstallationByHandle(botID, handle string) (*store.AppInstallation, error)    { return nil, nil }
func (s *Store) InstalledAppIDs(userID string) (map[string]bool, error)                          { return nil, nil }
func (s *Store) ListInstallationsByApp(appID string) ([]store.AppInstallation, error)            { return nil, nil }
func (s *Store) ListInstallationsByBot(botID string) ([]store.AppInstallation, error)            { return nil, nil }
func (s *Store) UpdateInstallation(id, handle string, config, scopes json.RawMessage, enabled bool) error { return nil }
...
func (s *Store) ListMediaUsageAgg(filter store.MediaUsageFilter) ([]store.MediaUsageAggregate, error) { return nil, nil }

func (s *Store) RecordLLMUsage(rec *store.LLMUsageRecord) error                                 { return nil }
func (s *Store) ListLLMUsageAgg(filter store.UsageFilter) ([]store.UsageAggregate, error)       { return nil, nil }
...
func (s *Store) CreateSkillVersion(v *store.SkillVersion) (*store.SkillVersion, error) { return nil, nil }
...
func (s *Store) ListWebhookLogs(botID, channelID string, limit int) ([]store.WebhookLog, error) { return nil, nil }
...
func (s *Store) UpdateEventLogFailed(id int64, errMsg string, retryCount int, durationMs int) error { return nil }
func (s *Store) ListEventLogs(installationID string, limit int) ([]store.AppEventLog, error)       { return nil, nil }
func (s *Store) CleanOldAppLogs(days int) error                                                      { return nil }

func (s *Store) CreateAPILog(log *store.AppAPILog) error                         { return nil }
func (s *Store) ListAPILogs(installationID string, limit int) ([]store.AppAPILog, error) { return nil, nil }

func (s *Store) CreateClient(ctx context.Context, c *store.Client) (*store.Client, error) { return nil, nil }
func (s *Store) GetClientByID(ctx context.Context, id string) (*store.Client, error)       { return nil, nil }
func (s *Store) GetClient(ctx context.Context, clientID, tenantID string) (*store.Client, error) { return nil, nil }
...
func (s *Store) ListClientsByTenant(ctx context.Context, tenantID string) ([]store.Client, error) { return nil, nil }
...
func (s *Store) CreateBindRequest(ctx context.Context, req *store.BindRequest) (*store.BindRequest, error) { return nil, nil }
func (s *Store) GetBindRequest(ctx context.Context, id string) (*store.BindRequest, error)               { return nil, nil }
...
func (s *Store) ListBindRequestsByClient(ctx context.Context, clientID string) ([]store.BindRequest, error) { return nil, nil }
...
func (s *Store) GetOAuthAccount(provider, providerID string) (*store.OAuthAccount, error) { return nil, nil }
...
func (s *Store) GetScanLoginSession(sessionID string) (*store.ScanLoginSession, error)       { return nil, nil }
...
func (s *Store) CreatePluginVersion(v *store.PluginVersion) (*store.PluginVersion, error)        { return nil, nil }
...
func (s *Store) GetTenantTasks(ctx context.Context, tenantID string, status *store.TaskStatus, limit int) ([]*store.Task, error) { return nil, nil }
func (s *Store) GetPendingTasksForClient(ctx context.Context, clientID string, limit int, sinceTaskID string) ([]*store.Task, error) { return nil, nil }
...
func (s *Store) CreateSkillUploadTicket(ctx context.Context, req *store.SkillUploadTicketRequest) (*store.SkillUploadTicket, error) { return nil, nil }
func (s *Store) ConfirmSkillInstall(ctx context.Context, clientID string, confirm *store.SkillInstallConfirm) (bool, error) { return true, nil }
func (s *Store) ReportSkillExecution(ctx context.Context, record *store.SkillExecutionReport) error { return nil }
func (s *Store) GetSkillEvaluation(ctx context.Context, skillID string) (*store.SkillEvaluation, error) { return nil, nil }

func (s *Store) CreateUploadTicket(ctx context.Context, skillID string, ttl int) (*store.UploadTicket, error) { return nil, nil }
func (s *Store) ConfirmUpload(ctx context.Context, ticketID string, success bool, sha256 string, size int64) (bool, error) { return true, nil }
func (s *Store) GetBillingConfig(ctx context.Context) (*store.BillingConfig, error) { return nil, nil }
func (s *Store) GetGarlicLedger(ctx context.Context, clientID string) (*store.GarlicLedger, error) { return nil, nil }
func (s *Store) ReportSearchSignals(ctx context.Context, record *store.SearchSignalsReport) error { return nil }
