...
export async function createChatSession(
  ...
  try {
    ...
    let titleDescriptor: SessionTitleDescriptor;
    let sessionName: string;

    if (skillName) {
      titleDescriptor = createTextSessionTitleDescriptor(skillName);
      sessionName = skillName;
    } else {
      ...
      titleDescriptor = createDefaultSessionTitleDescriptor(
        sessionMode,
        sameModeCount,
