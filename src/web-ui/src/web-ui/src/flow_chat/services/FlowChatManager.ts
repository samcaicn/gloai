...
export class FlowChatManager {
  ...
  async createChatSession(config: SessionConfig, mode?: string, skillName?: string): Promise<string> {
    return createChatSessionModule(this.context, config, mode, skillName);
  }
