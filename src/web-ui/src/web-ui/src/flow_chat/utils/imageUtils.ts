...
import type { FileContext, ImageContext } from '@/shared/types/context';
...
/**
 * Create FileContext from an attachment file selected by the user.
 * @param file File object from file picker
 * @returns FileContext with data URL for upload
 */
export async function createAttachmentContextFromFile(
  file: File
): Promise<FileContext> {
