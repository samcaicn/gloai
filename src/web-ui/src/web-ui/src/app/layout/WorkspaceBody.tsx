...
const WorkspaceBody: React.FC<WorkspaceBodyProps> = ({
  ...
  return (
    <div className={`bitfun-workspace-body${isEntering ? ' is-entering' : ''}${isExiting ? ' is-exiting' : ''}${isDividerHovered ? ' is-divider-hovered' : ''} ${className}`}>
      {/* Left: navigation sidebar — NavPanel fills the nav-area. When collapsed, the
          is-collapsed class hides the whole nav-area (width:0) per WorkspaceBody.scss. */}
      <div
      ...
      {/* Right: top bar (SceneBar) + scene content */}
