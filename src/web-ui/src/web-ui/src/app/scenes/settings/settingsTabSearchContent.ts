...
export const SETTINGS_TAB_SEARCH_CONTENT: Record<ConfigTab, readonly SettingsTabSearchPhrase[]> = {
  ...
  mesh: [
    { ns: 'common', key: 'meshSettings.title' },
    { ns: 'common', key: 'meshSettings.subtitle' },
    { ns: 'common', key: 'meshSettings.status' },
    { ns: 'common', key: 'meshSettings.role' },
    { ns: 'common', key: 'meshSettings.sectionSkills' },
    { ns: 'common', key: 'meshSettings.sectionCreate' },
    { ns: 'common', key: 'meshSettings.sectionJoin' },
    { ns: 'common', key: 'meshSettings.sectionPeers' },
    { ns: 'common', key: 'meshSettings.sectionSubmit' },
  ],

  // tupai tab 文案为字面量（不走 i18n），搜索索引留空；keyword 仍由 settingsConfig 提供
  tupai: [],

  // im-* 渠道 tab 文案为字面量（不走 i18n），搜索索引留空；keyword 仍由 settingsConfig 提供
  'im-wecom-bot': [],
  'im-feishu': [],
  'im-dingtalk': [],
  'im-long-conn': [],
