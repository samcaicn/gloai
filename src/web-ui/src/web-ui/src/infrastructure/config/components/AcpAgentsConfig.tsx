...
const AcpAgentsConfig: React.FC = () => {
  ...
  const refreshRequirementProbes = useCallback(async (
    ...
    try {
      ...
      if (requirementProbeRequestIdRef.current === requestId) {
        setRequirementProbes(Array.isArray(nextRequirementProbes) ? nextRequirementProbes : []);
      }
    } catch (error) {
  ...
  const refreshRemoteRequirementProbes = useCallback(async (
    ...
    try {
      ...
      setRemoteRequirementProbes(prev => ({
        ...prev,
        [normalizedConnectionId]: Array.isArray(nextRequirementProbes) ? nextRequirementProbes : [],
      }));
    } catch (error) {
  ...
  const loadConfig = useCallback(async (
    ...
    try {
      ...
      setSavedConnections(Array.isArray(nextSavedConnections) ? nextSavedConnections : []);
      setDirty(false);
