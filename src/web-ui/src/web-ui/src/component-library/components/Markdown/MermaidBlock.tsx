...
const isCodeComplete = (code: string): boolean => {
  ...
  // Accept any non-empty mermaid block so all diagram types render
  // (graph/flowchart/sequenceDiagram/gantt/mindmap/timeline plus newer
  // types such as block-beta, xychart-beta, sankey-beta, packet-beta,
  // architecture-beta, C4Context, requirementDiagram, ...). Invalid
  // syntax is caught by MermaidService.parse and surfaced in error state.
  return true;
};
