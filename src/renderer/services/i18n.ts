...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    coworkWorkingDirectoryHint: 'GGAi 将在此目录下执行命令',
    coworkSystemPrompt: '系统提示词',
    coworkSystemPromptPlaceholder: '为 GGAi 设置自定义指令...',
    coworkSystemPromptHint: '可选的系统提示词，用于自定义 GGAi 的行为',
    coworkModelSettingsRequired: '请先在模型设置中配置可用模型与 API Key。',
    coworkModelSettingsTitle: '模型设置',
    coworkModelSettingsHint: 'GGAi 使用模型设置中的当前模型与提供商配置。',
    ...
    coworkPermissionDescription: 'GGAi 请求执行以下操作',
    coworkToolName: '工具名称',
    ...
    coworkWelcome: '立即进入AGI时代',
    coworkDescription: '7×24 小时工作的全能助理',
    ...
    skillsDescription: '集合全球最佳的skills技能和智能体agent！开发者注册上架点我',
    skillsRoot: '技能目录',
    ...
    scheduledTasksErrorCount: '连续错误次数',
    ...
    scheduledTasksFormNotifyWework: '企业微信',
  ...
  en: {
    ...
    coworkWorkingDirectoryHint: 'GGAi will execute commands in this directory',
    coworkSystemPrompt: 'System Prompt',
    coworkSystemPromptPlaceholder: 'Set custom instructions for GGAi...',
    coworkSystemPromptHint: 'Optional system prompt to customize GGAi\'s behavior',
    ...
    coworkModelSettingsHint: 'GGAi uses the current model and provider configuration from Model Settings.',
    ...
    coworkPermissionDescription: 'GGAi is requesting to perform the following action',
    ...
    coworkLoadingSession: 'Loading session...',
    ...
    scheduledTasksErrorCount: 'Consecutive errors',
    ...
    scheduledTasksFormNotifyTelegram: 'Telegram',
    scheduledTasksFormNotifyDiscord: 'Discord',
    scheduledTasksFormNotifyWework: 'WeWork',
