...
interface IElectronAPI {
  ...
  im: {
    ...
    startGateway: (platform: 'dingtalk' | 'feishu' | 'telegram' | 'discord' | 'wework') => Promise<{ success: boolean; error?: string }>;
    stopGateway: (platform: 'dingtalk' | 'feishu' | 'telegram' | 'discord' | 'wework') => Promise<{ success: boolean; error?: string }>;
    testGateway: (
      platform: 'dingtalk' | 'feishu' | 'telegram' | 'discord' | 'wework',
  ...
  tuptup: {
    setConfig: (config: { apiKey: string; apiSecret: string; userId: string }) => Promise<{ success: boolean; error?: string }>;
    getConfig: () => Promise<{ success: boolean; config?: { apiKey: string; apiSecret: string; userId: string }; error?: string }>;
    clearConfig: () => Promise<{ success: boolean; error?: string }>;
    getUserInfo: () => Promise<{ success: boolean; data?: any; error?: string }>;
    getTokenBalance: () => Promise<{ success: boolean; data?: any; error?: string }>;
