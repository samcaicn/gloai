 ...
 *
 * Log file locations:
 *   macOS:   ~/Library/Logs/OriginClaw/main.log
 *   Windows: %USERPROFILE%\AppData\Roaming\OriginClaw\logs\main.log
 *   Linux:   ~/.config/OriginClaw/logs/main.log
 */
...
export function initLogger(): void {
  ...
  // Log startup marker
  log.info('='.repeat(60));
  log.info(`OriginClaw started (${process.platform} ${process.arch})`);
  log.info('='.repeat(60));
}
