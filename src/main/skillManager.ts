...
const downloadGithubArchive = async (
    ...
    archiveUrlCandidates.push(
      {
        ...
        headers: { 'User-Agent': 'OriginClaw Skill Downloader' },
      },
      {
  ...
  archiveUrlCandidates.push({
    ...
    headers: {
      ...
      'User-Agent': 'OriginClaw Skill Downloader',
          ...
          if (githubSource) {
            try {
              ...
              if (errno === 'ENOENT' && process.platform === 'win32') {
                throw new Error(
                  'Git executable not found. Please install Git for Windows or reinstall OriginClaw with bundled PortableGit.'
            ...
            throw new Error('Git executable not found. Please install Git for Windows or reinstall OriginClaw with bundled PortableGit.');
          } else {
            throw error;
          }
        }
