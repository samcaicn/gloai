/**
 * dsh-plugin-desktop — Cordis 浏览器端插件
 *
...
const PLUGIN_ID = 'dsh-plugin-desktop-client'

function desktopClientFactory(ctx: CordisContext): void {
  console.log(`[${PLUGIN_ID}] 桌面客户端插件已加载`)
  // TODO: 注册桌面相关的 UI 组件 via slots
}
...
export { desktopClientFactory, PLUGIN_ID }
