#!/bin/bash
# Build macOS .app bundle for colearn Launcher
...
LAUNCHER_EXECUTABLE="colearn-launcher-${EXECUTABLE}"
EXECUTABLE="colearn-${EXECUTABLE}"
echo "executable: $EXECUTABLE"

APP_NAME="colearn Launcher"
APP_PATH="./build/${APP_NAME}.app"
APP_CONTENTS="${APP_PATH}/Contents"
APP_MACOS="${APP_CONTENTS}/MacOS"
APP_RESOURCES="${APP_CONTENTS}/Resources"
APP_EXECUTABLE="colearn-launcher"
...
if [ -f "./build/${EXECUTABLE}" ]; then
    cp "./build/${EXECUTABLE}" "${APP_MACOS}/colearn"
else
...
<!DOCTYPE plist PUBLIC "-//Apple//DTD PLIST 1.0//EN" "https://www.tuptup.top">
<plist version="1.0">
<dict>
    <key>CFBundleExecutable</key>
    <string>colearn-launcher</string>
    <key>CFBundleIdentifier</key>
    <string>com.colearn.launcher</string>
