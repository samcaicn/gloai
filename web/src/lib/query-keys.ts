export const queryKeys = {
  ...
  skills: {
    all: (params?: Record<string, unknown>) => ["skills", params ?? {}] as const,
    detail: (id: string) => ["skills", id] as const,
    versions: (id: string) => ["skills", id, "versions"] as const,
    ratings: (id: string) => ["skills", id, "ratings"] as const,
    installs: () => ["skills", "installs"] as const,
    adminAll: (listing?: string) => ["skills", "admin", { listing }] as const,
    adminPending: () => ["skills", "admin", "pending"] as const,
  },
  ...
  admin: {
    ...
    scanLoginRoleConfig: () => ["admin", "scan-login-role-config"] as const,
    llmUsage: (params?: {
      tenant?: string;
      model?: string;
      model_type?: string;
      ...
      to?: number;
      limit?: number;
    }) => ["admin", "llm-usage", params ?? {}] as const,
    mediaUsage: (params?: {
      tenant?: string;
      model?: string;
      media_type?: string;
      ...
      to?: number;
      limit?: number;
    }) => ["admin", "media-usage", params ?? {}] as const,
  },
