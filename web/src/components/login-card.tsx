...
import { KeyRound, Shield, User, Lock, ArrowRight, Loader2, X, QrCode, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="w-full">
      <div className="mb-6 text-center space-y-2">
        ...
        <h1 className="text-2xl font-extrabold tracking-tight sm:text-3xl">CEOadmin Hub</h1>
