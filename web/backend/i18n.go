...
var translations = map[Language]map[TranslationKey]string{
	LanguageEnglish: {
		...
		MenuOpenTooltip:    "Open colearn console in browser",
		MenuAbout:          "About",
		MenuAboutTooltip:   "About colearn",
		...
		MenuQuit:           "Quit",
		MenuQuitTooltip:    "Exit colearn",
		Exiting:            "Exiting colearn...",
		DocUrl:             "https://www.tuptup.top",
	},
	LanguageChinese: {
		AppTooltip:         "%s - Web Console",
		MenuOpen:           "打开控制台",
		MenuOpenTooltip:    "在浏览器中打开 colearn 控制台",
		MenuAbout:          "关于",
		MenuAboutTooltip:   "关于 colearn",
		MenuVersion:        "版本: %s",
		...
		MenuQuit:           "退出",
		MenuQuitTooltip:    "退出 colearn",
		Exiting:            "正在退出 colearn...",
		DocUrl:             "https://www.tuptup.top",
	},
}
