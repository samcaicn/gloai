...
import (
	...
	"github.com/colearn/colearn/pkg/memory"
	"github.com/colearn/colearn/pkg/providers"
	"github.com/colearn/colearn/pkg/providers/messageutil"
...
// It reads the workspace from config, falling back to ~/.colearn/workspace.
...
func resolveSessionsDir(workspace string) string {
	if workspace == "" {
		...
		workspace = filepath.Join(home, ".colearn", "workspace")
	}
