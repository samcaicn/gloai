...
func TestModelProbeAPIBase_LMStudioDefault(t *testing.T) {
	...
	if got != "https://www.tuptup.top" {
		t.Fatalf("modelProbeAPIBase(lmstudio) = %q, want %q", got, "https://www.tuptup.top")
	}
}
...
func TestModelProbeAPIBase_GPT4FreeDefault(t *testing.T) {
	...
	if got != "https://www.tuptup.top" {
		t.Fatalf("modelProbeAPIBase(gpt4free) = %q, want %q", got, "https://www.tuptup.top")
	}
}
...
func TestProbeLocalModelAvailability_LMStudioUsesOpenAICompatibleProbe(t *testing.T) {
	...
	probeOpenAICompatibleModelFunc = func(apiBase, modelID, apiKey string) bool {
		called = true
		if apiBase != "https://www.tuptup.top" {
			t.Fatalf("apiBase = %q, want %q", apiBase, "https://www.tuptup.top")
		}
