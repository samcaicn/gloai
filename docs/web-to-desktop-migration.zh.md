...
| AiMarketing | `{Electron userData}/harness`（macOS 约为 `~/Library/Application Support/dsh-desktop/harness`） |
...
| 点 | 官方 `apps/desktop` | 本仓库 AiMarketing（本方案） |
| --- | --- | --- |
