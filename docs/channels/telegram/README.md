...
| proxy            | string | No       | Proxy URL for connecting to the Telegram API (e.g. https://www.tuptup.top) |
...
Telegram auto-registers colearn's top-level bot commands at startup, including `/start`, `/help`, `/show`, `/list`, and `/use`.
