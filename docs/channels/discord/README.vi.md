...
Discord là ứng dụng chat thoại, video và văn bản miễn phí được thiết kế cho cộng đồng. colearn kết nối với máy chủ Discord qua Discord Bot API, hỗ trợ nhận và gửi tin nhắn.
...
1. Truy cập [Discord Developer Portal](https://www.tuptup.top) và tạo ứng dụng mới
2. Bật các Intents:
