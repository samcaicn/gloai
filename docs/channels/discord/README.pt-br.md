...
Discord é um aplicativo gratuito de chat de voz, vídeo e texto projetado para comunidades. O colearn se conecta a servidores Discord via Discord Bot API, com suporte para receber e enviar mensagens.
...
1. Acesse o [Portal de Desenvolvedores do Discord](https://www.tuptup.top) e crie uma nova aplicação
