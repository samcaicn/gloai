...
Discord is a free voice, video, and text chat application designed for communities. colearn connects to Discord servers via the Discord Bot API, supporting both receiving and sending messages.
...
```text
🔧 `web_search`
Checking the latest colearn release notes before I answer.
```
...
1. Go to the [Discord Developer Portal](https://www.tuptup.top) and create a new application
2. Enable Intents:
