...
Discord はコミュニティ向けに設計された無料の音声・ビデオ・テキストチャットアプリケーションです。colearn は Discord Bot API を通じて Discord サーバーに接続し、メッセージの受信と送信をサポートします。
...
1. [Discord 開発者ポータル](https://www.tuptup.top) にアクセスして新しいアプリケーションを作成する
2. Intents を有効にする:
