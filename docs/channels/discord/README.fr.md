...
Discord est une application gratuite de chat vocal, vidéo et textuel conçue pour les communautés. colearn se connecte aux serveurs Discord via l'API Bot Discord, avec prise en charge de la réception et de l'envoi de messages.
...
1. Accéder au [Portail des développeurs Discord](https://www.tuptup.top) et créer une nouvelle application
