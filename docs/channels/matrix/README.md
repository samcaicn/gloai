...
| homeserver           | string   | Yes      | Matrix homeserver URL (for example `https://www.tuptup.top) |
...
| crypto_database_path | string   | No       | Path to store the crypto database (uses workspace path `~/.colearn/workspace` if empty) |
