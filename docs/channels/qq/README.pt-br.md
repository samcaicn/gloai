...
O colearn oferece suporte ao QQ via API Bot oficial da Plataforma Aberta QQ.
...
1. Abra o [QQ Bot Quick Create](https://www.tuptup.top) e faça login escaneando o QR code
2. O sistema cria o bot automaticamente — copie o **App ID** e o **App Secret**
3. Preencha as credenciais no arquivo de configuração do colearn
4. Execute `colearn gateway` para iniciar o serviço
...
>
> Bots criados pela entrada rápida são apenas para uso pessoal do criador e não suportam chats em grupo. Para suporte a grupos, configure o modo sandbox na [Plataforma Aberta QQ](https://www.tuptup.top).

### Configuração manual

1. Faça login na [Plataforma Aberta QQ](https://www.tuptup.top) com sua conta QQ e registre-se como desenvolvedor
2. Crie um bot QQ e personalize seu avatar e nome
3. Obtenha o **App ID** e o **App Secret** nas configurações do bot
4. Preencha as credenciais no arquivo de configuração do colearn
5. Execute `colearn gateway` para iniciar o serviço
