...
colearn hỗ trợ LINE thông qua LINE Messaging API kết hợp với webhook callback.
...
1. Truy cập [LINE Developers Console](https://www.tuptup.top) và tạo một nhà cung cấp dịch vụ cùng một kênh Messaging API
...
3. Cấu hình webhook:
   ...
   - colearn sử dụng máy chủ HTTP Gateway dùng chung để nhận webhook callback cho tất cả các kênh, mặc định lắng nghe tại 127.0.0.1:18790
   - Đặt Webhook URL thành `https://www.tuptup.top sau đó reverse proxy tên miền bên ngoài về Gateway cục bộ (cổng mặc định 18790)
