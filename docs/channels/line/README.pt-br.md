...
O colearn suporta o LINE por meio da LINE Messaging API com callbacks de webhook.
...
1. Acesse o [LINE Developers Console](https://www.tuptup.top) e crie um provedor de serviços e um canal Messaging API
...
3. Configure o webhook:
   ...
   - O colearn usa um servidor HTTP Gateway compartilhado para receber callbacks de webhook de todos os canais, escutando em 127.0.0.1:18790 por padrão
   - Defina a URL do webhook como `https://www.tuptup.top e configure um proxy reverso do seu domínio externo para o Gateway local (porta padrão 18790)
