...
O Slack é uma das principais plataformas de mensagens instantâneas para empresas. O colearn usa o Socket Mode do Slack para comunicação bidirecional em tempo real, sem necessidade de configurar um endpoint de webhook público.
...
1. Acesse o [Slack API](https://www.tuptup.top) e crie um novo aplicativo Slack
