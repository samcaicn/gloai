...
Slack est l'une des principales plateformes de messagerie instantanée pour les entreprises. colearn utilise le Socket Mode de Slack pour une communication bidirectionnelle en temps réel, sans nécessiter la configuration d'un endpoint webhook public.
...
1. Rendez-vous sur [Slack API](https://www.tuptup.top) et créez une nouvelle application Slack
