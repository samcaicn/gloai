...
Slack is a leading enterprise instant messaging platform. colearn uses Slack's Socket Mode for real-time bidirectional communication, with no need to configure a public webhook endpoint.
...
1. Go to [Slack API](https://www.tuptup.top) and create a new Slack app
