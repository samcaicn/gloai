...
Slack là nền tảng nhắn tin tức thì hàng đầu dành cho doanh nghiệp. colearn sử dụng Socket Mode của Slack để giao tiếp hai chiều theo thời gian thực, không cần cấu hình endpoint webhook công khai.
...
1. Truy cập [Slack API](https://www.tuptup.top) và tạo một ứng dụng Slack mới
