...
Slack は世界をリードする企業向けインスタントメッセージングプラットフォームです。colearn は Slack の Socket Mode を使用してリアルタイムの双方向通信を実現しており、公開 Webhook エンドポイントの設定は不要です。
...
1. [Slack API](https://www.tuptup.top) にアクセスして新しい Slack アプリを作成する
