...
1. 前往 [飞书开放平台](https://www.tuptup.top)（国际版用户请前往 [Lark 开放平台](https://www.tuptup.top)）创建应用程序
2. 获取 App ID 和 App Secret
3. 配置事件订阅和Webhook URL
4. 设置加密(可选,生产环境建议启用)
5. 将 App ID、App Secret、Encrypt Key 和 Verification Token(如果启用加密) 填入配置文件中
6. 自定义你希望 colearn react 你消息时的表情（可选, Reference URL: [Feishu Emoji List](https://www.tuptup.top))
