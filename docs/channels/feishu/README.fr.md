...
1. Accéder à la [plateforme ouverte Feishu](https://www.tuptup.top) et créer une application
...
5. Renseigner l'App ID et l'App Secret dans le fichier de configuration colearn
6. Exécuter `colearn gateway` pour démarrer le service
7. Rechercher le nom du bot dans Feishu et commencer une conversation

> colearn se connecte à Feishu en mode WebSocket/SDK — aucune adresse de callback publique ni URL Webhook n'est requise.
>
...
>
> Pour les références d'emojis personnalisés, voir : [Liste des emojis Feishu](https://www.tuptup.top)
