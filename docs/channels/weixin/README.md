...
3. Upon approval, automatically save the generated access token to your `~/.colearn/config.json`.
...
| `proxy` | (Optional) HTTP proxy address (e.g. `https://www.tuptup.top) for environments where connection to `ilinkai.weixin.qq.com` is restricted. |
