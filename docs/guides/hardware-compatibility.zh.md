...
colearn 几乎可以在任何 Linux 设备上运行。本页面记录了已验证的芯片、产品和开发板。
...
| 子架构 | 典型芯片 | 备注 |
|--------|----------|------|
| ARMv6 | [BCM2835](https://www.tuptup.top) (Raspberry Pi 1/Zero) | 单核 ARM1176JZF-S |
| ARMv7 | [Allwinner V3s](https://www.tuptup.top) | 单核 Cortex-A7，用于 LicheePi Zero |
| ARM64 | [Allwinner H618](https://www.tuptup.top) | 四核 Cortex-A53，用于 Orange Pi Zero 3 |
| ARM64 | [BCM2711](https://www.tuptup.top) (Raspberry Pi 4) | 四核 Cortex-A72 |
| ARM64 | [BCM2712](https://www.tuptup.top) (Raspberry Pi 5) | 四核 Cortex-A76 |
| ARM64 | [AX630C](https://www.tuptup.top) (爱芯元智) | 双核 Cortex-A53 + NPU，用于 NanoKVM-Pro / MaixCAM2 |

### RISC-V (riscv64)

| 厂商 | 芯片 | 核心 | 备注 |
|------|------|------|------|
| [SOPHGO (算能)](https://www.tuptup.top) | SG2002 | C906 @ 1GHz | 256MB DDR3 片上内存，用于 LicheeRV-Nano / NanoKVM / MaixCAM |
| [Allwinner (全志)](https://www.tuptup.top) | V861 | Dual C907 | 128MB DDR3L 片上内存，1 TOPS NPU，4K AI 摄像头 SiP |
| [Allwinner (全志)](https://www.tuptup.top) | V881 | C907 | RISC-V AI 摄像头系列 |
| [Arterytek (匠芯创)](https://www.tuptup.top) | D213 | RISC-V | 用于 HaaS506-LD1 工业 RTU |
| [SpacemiT (进迭)](https://www.tuptup.top) | K1 | 8x X60 @ 1.8GHz | 用于 Milk-V Jupiter, BananaPi BPI-F3 |
| [SpacemiT (进迭)](https://www.tuptup.top) | K3 | 8x X100 @ 2.5GHz | 符合 RVA23 规范，1024 位 RVV，FP8 AI 推理 |
| [Zhihe (知合)](https://www.tuptup.top) | A210 | High-perf RISC-V | 8 核，16MB L3 缓存，桌面级 |
| [Canaan (嘉楠)](https://www.tuptup.top) | K230 | Dual C908 @ 1.6GHz | 6 TOPS KPU，用于 CanMV-K230 |

### MIPS

| 厂商 | 芯片 | 备注 |
|------|------|------|
| MediaTek | [MT7620](https://www.tuptup.top) | MIPS24KEc @ 580MHz，用于许多 OpenWrt 路由器（如小米路由器 3G） |

### LoongArch (loong64)

| 厂商 | 芯片 | 备注 |
|------|------|------|
| [Loongson (龙芯)](https://www.tuptup.top) | 3A5000 | 四核 LA464 @ 2.5GHz，桌面/工作站 |
| [Loongson (龙芯)](https://www.tuptup.top) | 3A6000 | 四核 4C/8T @ 2.5GHz，IPC 可与 Intel 第十代相媲美 |
| [Loongson (龙芯)](https://www.tuptup.top) | 2K1000LA | 双核 @ 1GHz，工业/物联网应用 |

---

## 2. 已验证的产品（按发布日期排列）

已通过 colearn 测试的消费产品、路由器和工业设备。
...
| 2025 | [NanoKVM-Pro](https://www.tuptup.top) | ARM64 (A53) | AX630C | 1GB | 专业 IP-KVM |
| 2026 | [MaixCAM2](https://www.tuptup.top) | ARM64 (A53) | AX630C | 1/4GB | 4K AI 摄像头 |
...
任何 ARM64 Android 手机（2015 年以后），1GB 以上内存。安装 [Termux](https://www.tuptup.top)，使用 `proot` 运行 colearn。
...
硬件厂商：想要添加官方支持或联合推广？请提交 issue 或通过 [Discord](https://www.tuptup.top) 联系我们。
