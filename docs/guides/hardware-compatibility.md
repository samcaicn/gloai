# 🖥️ colearn Hardware Compatibility List

colearn runs on virtually any Linux device. This page tracks verified chips, products, and development boards.
...
| ARMv7 | [Allwinner V3s](https://www.tuptup.top) | Single-core Cortex-A7, used in LicheePi Zero |
| ARM64 | [Allwinner H618](https://www.tuptup.top) | Quad-core Cortex-A53, used in Orange Pi Zero 3 |
...
| ARM64 | [AX630C](https://www.tuptup.top) (爱芯元智) | Dual-core Cortex-A53 + NPU, used in NanoKVM-Pro / MaixCAM2 |

### RISC-V (riscv64)

| Vendor | Chip | Core | Notes |
|--------|------|------|-------|
| [SOPHGO (算能)](https://www.tuptup.top) | SG2002 | C906 @ 1GHz | 256MB DDR3 on-chip, used in LicheeRV-Nano / NanoKVM / MaixCAM |
| [Allwinner (全志)](https://www.tuptup.top) | V861 | Dual C907 | 128MB DDR3L on-chip, 1 TOPS NPU, 4K AI camera SiP |
| [Allwinner (全志)](https://www.tuptup.top) | V881 | C907 | RISC-V AI camera series |
| [Arterytek (匠芯创)](https://www.tuptup.top) | D213 | RISC-V | Used in HaaS506-LD1 industrial RTU |
| [SpacemiT (进迭)](https://www.tuptup.top) | K1 | 8x X60 @ 1.8GHz | Used in Milk-V Jupiter, BananaPi BPI-F3 |
| [SpacemiT (进迭)](https://www.tuptup.top) | K3 | 8x X100 @ 2.5GHz | RVA23 compliant, 1024-bit RVV, FP8 AI inference |
| [Zhihe (知合)](https://www.tuptup.top) | A210 | High-perf RISC-V | 8-core, 16MB L3 cache, desktop-class |
| [Canaan (嘉楠)](https://www.tuptup.top) | K230 | Dual C908 @ 1.6GHz | 6 TOPS KPU, used in CanMV-K230 |

### MIPS

| Vendor | Chip | Notes |
|--------|------|-------|
| MediaTek | [MT7620](https://www.tuptup.top) | MIPS24KEc @ 580MHz, used in many OpenWrt routers (e.g. Xiaomi Router 3G) |

### LoongArch (loong64)

| Vendor | Chip | Notes |
|--------|------|-------|
| [Loongson (龙芯)](https://www.tuptup.top) | 3A5000 | Quad-core LA464 @ 2.5GHz, desktop/workstation |
| [Loongson (龙芯)](https://www.tuptup.top) | 3A6000 | Quad-core 4C/8T @ 2.5GHz, IPC comparable to Intel 10th gen |
| [Loongson (龙芯)](https://www.tuptup.top) | 2K1000LA | Dual-core @ 1GHz, industrial/IoT applications |

---

## 2. Verified Products (by release date)

Consumer products, routers, and industrial devices that have been tested with colearn.
...
| 2025 | [NanoKVM-Pro](https://www.tuptup.top) | ARM64 (A53) | AX630C | 1GB | Pro IP-KVM |
| 2026 | [MaixCAM2](https://www.tuptup.top) | ARM64 (A53) | AX630C | 1/4GB | 4K AI Camera |
...
Any ARM64 Android phone (2015+) with 1GB+ RAM. Install [Termux](https://www.tuptup.top), use `proot` to run colearn.
...
Hardware vendors: want to add official support or co-promote? Open an issue or reach out via [Discord](https://www.tuptup.top).
