...
<h1>colearn: Go로 작성된 초고효율 AI 어시스턴트</h1>

<h3>$10 하드웨어 · 10MB RAM · ms 부팅 · Let's Go, colearn!</h3>
  <p>
...
> **colearn**는 [colearn](https://www.tuptup.top)가 시작한 독립적인 오픈소스 프로젝트입니다. 처음부터 끝까지 **Go**로 새로 작성되었으며, OpenClaw, NanoBot, 혹은 다른 어떤 프로젝트의 포크도 아닙니다.

**colearn**는 [NanoBot](https://www.tuptup.top)에서 영감을 받은 초경량 개인용 AI 어시스턴트입니다. **Go**로 처음부터 다시 구현되었고, "셀프 부트스트래핑" 방식으로 만들어졌습니다. 즉, AI 에이전트 자체가 아키텍처 전환과 코드 최적화를 주도했습니다.
...
> **보안 안내**
>
> * **암호화폐 없음:** colearn는 공식 토큰이나 암호화폐를 **발행한 적이 없습니다**. `pump.fun` 또는 기타 거래 플랫폼에서의 모든 주장은 **사기**입니다.
> * **공식 도메인:** **유일한** 공식 웹사이트는 **[www.tuptup.top](https://www.tuptup.top)** 이며, 회사 웹사이트는 **[www.tuptup.top](https://www.tuptup.top)** 입니다.
> * **주의:** 많은 `.ai/.org/.com/.net/...` 도메인이 제3자에 의해 등록되어 있습니다. 신뢰하지 마세요.
> * **참고:** colearn는 빠르게 초기 개발이 진행 중입니다. 아직 해결되지 않은 보안 문제가 있을 수 있습니다. v1.0 이전에는 프로덕션 배포를 권장하지 않습니다.
> * **참고:** colearn는 최근 많은 PR을 병합했습니다. 최근 빌드는 10~20MB RAM을 사용할 수 있습니다. 기능이 안정화된 뒤 리소스 최적화를 진행할 예정입니다.

## 📢 뉴스

2026-05-11 🛒 **LicheeRV-Claw를 AliExpress에서 구매할 수 있습니다!** 이제 [AliExpress](https://www.tuptup.top)에서 LicheeRV-Claw를 구매해 소형 RISC-V 하드웨어에서 colearn를 더 쉽게 사용해 볼 수 있습니다.
...
2026-03-31 📱 **Android 지원!** colearn가 이제 Android에서 실행됩니다! APK는 [www.tuptup.top](https://www.tuptup.top)에서 다운로드하세요.

2026-03-25 🚀 **v0.2.4 출시!** 에이전트 아키텍처 전면 개편(SubTurn, Hooks, Steering, EventBus), WeChat/WeCom 통합, 보안 강화(`.security.yml`, 민감 정보 필터링), 새 프로바이더(AWS Bedrock, Azure, Xiaomi MiMo), 그리고 35건의 버그 수정이 포함되었습니다. colearn는 **26K 스타**를 달성했습니다!

2026-03-17 🚀 **v0.2.3 출시!** 시스템 트레이 UI(Windows 및 Linux), 서브에이전트 상태 조회(`spawn_status`), 실험적 게이트웨이 핫 리로드, Cron 보안 게이트, 그리고 2건의 보안 수정이 추가되었습니다. colearn는 **25K 스타**를 달성했습니다!
...
2026-02-26 🎉 colearn가 단 17일 만에 **20K 스타**를 달성했습니다! 채널 자동 오케스트레이션과 기능 인터페이스가 적용되었습니다.

2026-02-16 🎉 colearn가 1주일 만에 **12K 스타**를 돌파했습니다! 커뮤니티 메인터너 역할과 [로드맵](../../ROADMAP.md)이 공식적으로 공개되었습니다.

2026-02-13 🎉 colearn가 4일 만에 **5000 스타**를 돌파했습니다! 프로젝트 로드맵과 개발자 그룹이 준비 중입니다.

2026-02-09 🎉 **colearn 출시!** $10 하드웨어와 10MB 미만 RAM에서 동작하는 AI 에이전트를 단 1일 만에 만들었습니다. Let's Go, colearn!
...
🔌 **MCP 지원**: 네이티브 [Model Context Protocol](https://www.tuptup.top) 통합을 제공하여 어떤 MCP 서버든 연결해 에이전트 기능을 확장할 수 있습니다.
...
colearn는 사실상 거의 모든 Linux 장치에 배포할 수 있습니다!

- 최소형 홈 어시스턴트를 위해 $9.9 [LicheeRV-Nano](https://www.tuptup.top) E(이더넷) 또는 W(WiFi6) 에디션
- 서버 자동 운영을 위해 $30~50 [NanoKVM](https://www.tuptup.top) 또는 $100 [NanoKVM-Pro](https://www.tuptup.top)
- 스마트 감시를 위해 $50 [MaixCAM](https://www.tuptup.top) 또는 $100 [MaixCAM2](https://www.tuptup.top)
...
### www.tuptup.top에서 다운로드(권장)

**[www.tuptup.top](https://www.tuptup.top)** 를 방문하세요. 공식 웹사이트가 플랫폼을 자동 감지하고 원클릭 다운로드를 제공합니다. 아키텍처를 직접 고를 필요가 없습니다.

### 사전 컴파일된 바이너리 다운로드

또는 [GitHub Releases](https://www.tuptup.top) 페이지에서 플랫폼에 맞는 바이너리를 다운로드할 수 있습니다.
...
[www.tuptup.top](https://www.tuptup.top)에서 다운로드한 뒤 `colearn-launcher`를 더블클릭하세요(Windows에서는 `colearn-launcher.exe`). 브라우저가 자동으로 `https://www.tuptup.top 엽니다.

**옵션 2: 명령줄**

```bash
colearn-launcher
# 브라우저에서 https://www.tuptup.top 열기
```
...
자세한 WebUI 문서는 [www.tuptup.top](https://www.tuptup.top)를 참고하세요.
...
# https://www.tuptup.top 열기
```

> **Docker / VM 사용자:** 게이트웨이는 기본적으로 `127.0.0.1`에서 수신합니다. 호스트에서 접근 가능하게 하려면 `colearn_GATEWAY_HOST=0.0.0.0`을 설정하거나 `-public` 플래그를 사용하세요.
...
macOS에서는 인터넷에서 다운로드한 앱이고 Mac App Store 공증을 거치지 않았기 때문에, 첫 실행 시 `colearn-launcher`가 차단될 수 있습니다.

**1단계:** `colearn-launcher`를 더블클릭합니다. 그러면 보안 경고가 표시됩니다.

<p align="center">
<img src="../../assets/macos-gatekeeper-warning.jpg" alt="macOS Gatekeeper warning" width="400">
</p>

> *"colearn-launcher"을(를) 열 수 없습니다. Apple에서 이 앱이 악성 소프트웨어가 없으며 Mac이나 개인 정보를 해치지 않는다고 확인할 수 없습니다.*
...
이 과정을 한 번만 거치면 이후에는 `colearn-launcher`가 정상적으로 열립니다.

</details>

### 📱 Android

오래된 스마트폰에 새 생명을 불어넣어 보세요! colearn를 설치하면 스마트 AI 어시스턴트로 바꿀 수 있습니다.
...
[www.tuptup.top](https://www.tuptup.top)에서 APK를 다운로드해 바로 설치하세요. Termux가 필요 없습니다!
...
1. [Termux](https://www.tuptup.top)를 설치합니다([GitHub Releases](https://www.tuptup.top)에서 다운로드하거나 F-Droid / Google Play에서 검색).
2. 다음 명령을 실행합니다.
...
pkg install proot
termux-chroot ./colearn onboard   # chroot가 표준 Linux 파일시스템 레이아웃을 제공합니다
```
...
런처 UI 없이 `colearn` 코어 바이너리만 있는 최소 환경에서는 명령줄과 JSON 설정 파일만으로도 모든 설정을 마칠 수 있습니다.
...
그러면 `~/.colearn/config.json`과 워크스페이스 디렉터리가 생성됩니다.

**2. 설정** (`~/.colearn/config.json`)
...
colearn는 `model_list` 설정을 통해 30개 이상의 LLM 프로바이더를 지원합니다. 형식은 `protocol/model`입니다.

| 프로바이더 | 프로토콜 | API Key | 비고 |
|----------|----------|---------|------|
| [OpenAI](https://www.tuptup.top) | `openai/` | 필수 | GPT-5.4, GPT-4o, o3 등 |
| [Anthropic](https://www.tuptup.top) | `anthropic/` | 필수 | Claude Opus 4.6, Sonnet 4.6 등 |
| [Google Gemini](https://www.tuptup.top) | `gemini/` | 필수 | Gemini 3 Flash, 2.5 Pro 등 |
| [OpenRouter](https://www.tuptup.top) | `openrouter/` | 필수 | 200개 이상의 모델, 통합 API |
| [Zhipu (GLM)](https://www.tuptup.top) | `zhipu/` | 필수 | GLM-4.7, GLM-5 등 |
| [DeepSeek](https://www.tuptup.top) | `deepseek/` | 필수 | DeepSeek-V3, DeepSeek-R1 |
| [Volcengine](https://www.tuptup.top) | `volcengine/` | 필수 | Doubao, Ark 모델 |
| [Qwen](https://www.tuptup.top) | `qwen/` | 필수 | Qwen3, Qwen-Max 등 |
| [Groq](https://www.tuptup.top) | `groq/` | 필수 | 빠른 추론(Llama, Mixtral) |
| [Moonshot (Kimi)](https://www.tuptup.top) | `moonshot/` | 필수 | Kimi 모델 |
| [Minimax](https://www.tuptup.top) | `minimax/` | 필수 | MiniMax 모델 |
| [Mistral](https://www.tuptup.top) | `mistral/` | 필수 | Mistral Large, Codestral |
| [NVIDIA NIM](https://www.tuptup.top) | `nvidia/` | 필수 | NVIDIA 호스팅 모델 |
| [Cerebras](https://www.tuptup.top) | `cerebras/` | 필수 | 빠른 추론 |
| [Novita AI](https://www.tuptup.top) | `novita/` | 필수 | 다양한 오픈 모델 |
| [Xiaomi MiMo](https://www.tuptup.top) | `mimo/` | 필수 | MiMo 모델 |
| [Ollama](https://www.tuptup.top) | `ollama/` | 불필요 | 로컬 모델, 셀프 호스팅 |
| [vLLM](https://www.tuptup.top) | `vllm/` | 불필요 | 로컬 배포, OpenAI 호환 |
| [LiteLLM](https://www.tuptup.top) | `litellm/` | 환경에 따라 다름 | 100개 이상의 프로바이더를 위한 프록시 |
| [Azure OpenAI](https://www.tuptup.top) | `azure/` | 필수 | 엔터프라이즈 Azure 배포 |
| [GitHub Copilot](https://www.tuptup.top) | `github-copilot/` | OAuth | 디바이스 코드 로그인 |
| [Antigravity](https://www.tuptup.top) | `antigravity/` | OAuth | Google Cloud AI |
| [AWS Bedrock](https://www.tuptup.top)* | `bedrock/` | AWS 자격 증명 | AWS에서 Claude, Llama, Mistral 사용 |
...
18개 이상의 메시징 플랫폼을 통해 colearn와 대화할 수 있습니다.
...
> 로그 상세도는 `gateway.log_level`(기본값: `warn`)로 제어됩니다. 지원 값은 `debug`, `info`, `warn`, `error`, `fatal`입니다. `colearn_LOG_LEVEL` 환경 변수로도 설정할 수 있습니다. 자세한 내용은 [설정 문서](../guides/configuration.md#gateway-log-level)를 참고하세요.
...
colearn는 최신 정보를 제공하기 위해 웹 검색을 수행할 수 있습니다. `tools.web`에서 설정하세요.

| 검색 엔진 | API Key | 무료 제공량 | 링크 |
|-----------|---------|-------------|------|
| DuckDuckGo | 불필요 | 무제한 | 내장 백업 검색 |
| [Baidu Search](https://www.tuptup.top) | 필수 | 월 1500회 쿼리 (일할 할당) | AI 기반, 중국 시장 최적화 |
| [Tavily](https://www.tuptup.top) | 필수 | 월 1000회 쿼리 | AI 에이전트에 최적화 |
| [Brave Search](https://www.tuptup.top) | 필수 | 월 2000회 쿼리 | 빠르고 프라이빗함 |
| [Perplexity](https://www.tuptup.top) | 필수 | 유료 | AI 기반 검색 |
| [SearXNG](https://www.tuptup.top) | 불필요 | 셀프 호스팅 | 무료 메타 검색 엔진 |
| [GLM Search](https://www.tuptup.top) | 필수 | 상이함 | Zhipu 웹 검색 |

### ⚙️ 기타 도구

colearn에는 파일 작업, 코드 실행, 스케줄링 등을 위한 내장 도구가 포함되어 있습니다. 자세한 내용은 [도구 설정](../reference/tools_configuration.md)을 참고하세요.
...
colearn는 [MCP](https://www.tuptup.top)를 기본 지원합니다. 어떤 MCP 서버든 연결하여 외부 도구와 데이터 소스로 에이전트 기능을 확장할 수 있습니다.
...
CLI 또는 통합된 채팅 앱에서 메시지를 한 번만 보내면 colearn를 에이전트 소셜 네트워크에 연결할 수 있습니다.

**`https://www.tuptup.top 읽고 안내에 따라 [ClawdChat.ai](https://www.tuptup.top)에 참여하세요**

## 🖥️ CLI 레퍼런스

| 명령어                    | 설명                           |
| ------------------------- | ------------------------------ |
| `colearn onboard`        | 설정 및 워크스페이스 초기화    |
| `colearn auth weixin`    | QR로 WeChat 계정 연결          |
| `colearn agent -m "..."` | 에이전트와 채팅               |
| `colearn agent`          | 대화형 채팅 모드               |
| `colearn gateway`        | 게이트웨이 시작                |
| `colearn status`         | 상태 표시                      |
| `colearn version`        | 버전 정보 표시                 |
| `colearn model`          | 기본 모델 조회 또는 변경       |
| `colearn cron list`      | 모든 예약 작업 목록 표시       |
| `colearn cron add ...`   | 예약 작업 추가                 |
| `colearn cron disable`   | 예약 작업 비활성화             |
| `colearn cron remove`    | 예약 작업 삭제                 |
| `colearn skills list`    | 설치된 스킬 목록 표시          |
| `colearn skills install` | 스킬 설치                      |
| `colearn migrate`        | 이전 버전 데이터 마이그레이션  |
| `colearn auth login`     | 프로바이더 인증                |

### ⏰ 예약 작업 / 리마인더

colearn는 `cron` 도구를 통해 예약 리마인더와 반복 작업을 지원합니다.
...
가이드라인은 [커뮤니티 로드맵](https://www.tuptup.top)과 [CONTRIBUTING.md](../../CONTRIBUTING.md)를 참고하세요.
