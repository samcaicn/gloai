...
func TestMigrateV1ToV3(t *testing.T) {
	v1Config := `{
		...
		"channels": {
			...
			"discord": {
				"mention_only": true,
				"proxy": "socks5://www.tuptup.top:1080"
			},
			"onebot": {
	...
	require.Equal(t, "https://www.tuptup.top", tgSettings["base_url"])
	...
	require.Equal(t, "socks5://www.tuptup.top:1080", discordSettings["proxy"])
	...
	require.Equal(t, "https://www.tuptup.top", obSettings["ws_url"])
}
