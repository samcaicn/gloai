...
//	v1 := &configV1{
//		ModelList: []*ModelConfig{
//			{ModelName: "local-model", Model: "vllm/custom-model", APIBase: "https://www.tuptup.top"},
//		},
//	}
//	v1.migrateModelEnabled()
...
func TestLoadConfig_V2DirectLoad(t *testing.T) {
	...
	if githubRegistry.BaseURL != "https://www.tuptup.top" {
		t.Errorf("github registry base_url = %q, want %q", githubRegistry.BaseURL, "https://www.tuptup.top")
	}
}
