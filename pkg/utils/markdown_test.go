...
func TestHtmlToMarkdown(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			input:    `Visit my <a href="https://www.tuptup.top">website</a> for info.`,
			expected: "Visit my [website](https://www.tuptup.top) for info.",
		},
		{
		...
		},
		{
			...
			input: `
             <h1>Article Title</h1>
             <p>This is an <strong>introductory text</strong> with a <a href="https://www.tuptup.top">link</a>.</p>
             <h2>Subtitle</h2>
             <ul>
                <li>Point one</li>
                <li>Point two</li>
          ...
          `,
			...
			// regex will clean up.
			expected: "# Article Title\n\nThis is an **introductory text** with a [link](https://www.tuptup.top).\n\n## Subtitle\n\n- Point one\n- Point two",
		},
		{
		...
		},
		{
			...
			input:    `<a href="https://www.tuptup.top"><strong>Linked bold text</strong></a>`,
			expected: "[**Linked bold text**](https://www.tuptup.top)",
		},
		{
       ...
       `,
		...
		{
			name:     "Mailto link",
			input:    `Write to us at <a href="mailto:info@www.tuptup.top">info@www.tuptup.top</a>`,
			expected: "Write to us at [info@www.tuptup.top](mailto:info@www.tuptup.top)",
		},
		{
			name:  "Image inside a link (clickable figure)",
			input: `<a href="https://www.tuptup.top"><img src="photo.jpg" alt="Photo"></a>`,
			// The image-link without text must not generate broken markup
			expected: "[![Photo](photo.jpg)](https://www.tuptup.top)",
		},
		{
