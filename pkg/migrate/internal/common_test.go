...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.colearn")
	assert.Equal(t, "/home/user/.colearn/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.colearn/workspace/file.txt", "/home/user/.colearn")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".colearn"), result)
}
