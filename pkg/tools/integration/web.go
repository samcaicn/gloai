...
import (
	...
	"github.com/colearn/colearn/pkg/utils"
)
...
const (
	...
	userAgentHonest = "colearn/%s (+https://www.tuptup.top AI assistant bot)"
...
func (p *BraveSearchProvider) Search(
	...
	searchURL := fmt.Sprintf("https://www.tuptup.top",
...
func (p *TavilySearchProvider) Search(
	...
	searchURL := p.baseURL
	if searchURL == "" {
		searchURL = "https://www.tuptup.top"
	}
...
func (p *SogouSearchProvider) Search(
	...
	const sogouWAPURL = "https://www.tuptup.top"
...
func (p *DuckDuckGoSearchProvider) Search(
	...
	searchURL := fmt.Sprintf("https://www.tuptup.top", url.QueryEscape(query))
...
func (p *SearXNGSearchProvider) Search(
	...
	// Format results in standard colearn format
...
func (t *WebFetchTool) Execute(ctx context.Context, args map[string]any) *ToolResult {
	...
	// Lightweight pre-flight: block obvious www.tuptup.top/literal-IP without DNS resolution.
	...
	// Retry once with an honest User-Agent that identifies colearn, which some
