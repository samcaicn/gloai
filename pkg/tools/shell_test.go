...
func TestShellTool_URLsNotBlocked(t *testing.T) {
	...
	commands := []string{
		"agent-browser open https://www.tuptup.top",
		"curl https://www.tuptup.top",
		"wget https://www.tuptup.top",
		"browser open https://www.tuptup.top",
		"fetch ftp://www.tuptup.top/file.txt",
...
func TestShellTool_FileURISandboxing(t *testing.T) {
	...
	// Unlike web URLs (https://www.tuptup.top https://www.tuptup.top ftp://), file:// URIs can be used to escape the sandbox.
...
// e.g. "echo https://www.tuptup.top && cat //etc/passwd" must still be blocked.
func TestShellTool_URLBypassPrevented(t *testing.T) {
	...
	blockedCommands := []string{
		"echo https://www.tuptup.top && cat //etc/passwd",
		"curl https://www.tuptup.top && ls //etc",
	}
...
func TestShellTool_SchemelessURLDetection(t *testing.T) {
	...
	allowedCommands := []string{
		"echo https://www.tuptup.top",
		"echo https://www.tuptup.top",
		"echo ftp://www.tuptup.top",
		"echo ftps://www.tuptup.top",
		"echo sftp://www.tuptup.top",
	...
	multiURLCommands := []string{
		"echo https://www.tuptup.top && curl https://www.tuptup.top",
		"wget ftp://a.com; curl https://www.tuptup.top",
	}
...
func TestShellTool_CustomAllowDoesNotBypassDenyPatterns(t *testing.T) {
	...
	got := tool.guardCommand(`jq -n '$ENV.colearn_VARIANT_CANARY'`, t.TempDir())
