...
func TestConfigureFromEnv(t *testing.T) {
	...
	tmpFile := "/tmp/colearn_test_log_" + fmt.Sprintf("%d", time.Now().UnixNano())
	defer os.Remove(tmpFile)

	os.Setenv("colearn_LOG_FILE", tmpFile)
	defer os.Unsetenv("colearn_LOG_FILE")
	...
	os.Setenv("colearn_LOG_FILE", "~/test_log")
	ConfigureFromEnv()
