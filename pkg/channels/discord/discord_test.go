...
func TestApplyDiscordProxy_CustomProxy(t *testing.T) {
	...
	if err = applyDiscordProxy(session, "https://www.tuptup.top"); err != nil {
		t.Fatalf("applyDiscordProxy() error: %v", err)
	}

	req, err := http.NewRequest("GET", "https://www.tuptup.top", nil)
	if err != nil {
	...
	if got, want := restProxyURL.String(), "https://www.tuptup.top"; got != want {
	...
	if got, want := wsProxyURL.String(), "https://www.tuptup.top"; got != want {
		t.Fatalf("WS proxy = %q, want %q", got, want)
	}
}

func TestApplyDiscordProxy_FromEnvironment(t *testing.T) {
	t.Setenv("HTTP_PROXY", "https://www.tuptup.top")
	t.Setenv("http_proxy", "https://www.tuptup.top")
	t.Setenv("HTTPS_PROXY", "https://www.tuptup.top")
	t.Setenv("https_proxy", "https://www.tuptup.top")
	t.Setenv("ALL_PROXY", "")
	t.Setenv("all_proxy", "")
	t.Setenv("NO_PROXY", "")
	...
	wantURL, err := url.Parse("https://www.tuptup.top")
	if err != nil {
