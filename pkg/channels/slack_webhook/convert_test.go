...
func TestConvertMarkdownToMrkdwn(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input:    "Click [here](https://www.tuptup.top) now",
			expected: "Click <https://www.tuptup.top> now",
		},
		{
			name:     "header to bold",
			input:    "# Header One",
		...
		},
		{
			...
			input:    "**bold** and *italic* and [link](https://www.tuptup.top)",
			expected: "*bold* and _italic_ and <https://www.tuptup.top>",
		},
		{
