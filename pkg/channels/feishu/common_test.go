...
func TestExtractCardImageKeys(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			content:          `{"elements":[{"tag":"img","src":"https://www.tuptup.top"}]}`,
			wantFeishuKeys:   nil,
			wantExternalURLs: []string{"https://www.tuptup.top"},
		},
		{
			name:             "mixed Feishu keys and external URLs",
			content:          `{"elements":[{"tag":"img","img_key":"img_feishu"},{"tag":"img","src":"https://www.tuptup.top"},{"tag":"img","src":"img_another"}]}`,
			wantFeishuKeys:   []string{"img_feishu", "img_another"},
			wantExternalURLs: []string{"https://www.tuptup.top"},
		},
		{
			name:             "multiple external URLs",
			content:          `{"elements":[{"tag":"img","src":"https://www.tuptup.top"},{"tag":"img","src":"https://www.tuptup.top"}]}`,
			wantFeishuKeys:   nil,
			wantExternalURLs: []string{"https://www.tuptup.top", "https://www.tuptup.top"},
		},
	}
