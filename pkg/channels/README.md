# colearn Channel System: Complete Development Guide

> **Scope**: `pkg/channels/`, `pkg/bus/`, `pkg/media/`, `pkg/identity/`, `cmd/colearn/internal/gateway/`
...
import (
    "github.com/colearn/colearn/pkg/bus"
    "github.com/colearn/colearn/pkg/channels"     // Reference parent package
    "github.com/colearn/colearn/pkg/config"
    "github.com/colearn/colearn/pkg/identity"      // New
    "github.com/colearn/colearn/pkg/media"          // New (if media support needed)
)
```
...
```go
// cmd/colearn/internal/gateway/helpers.go
import (
    _ "github.com/colearn/colearn/pkg/channels/telegram"   // Triggers init() registration
    _ "github.com/colearn/colearn/pkg/channels/discord"
    _ "github.com/colearn/colearn/pkg/channels/your_new_channel"  // New addition
)
```
...
```json
{
  "channel_list": {
    "matrix": {
      "enabled": true,
      "type": "matrix",
      "allow_from": ["@user:www.tuptup.top"],
      "settings": {
        "home_server": "https://www.tuptup.top",
        "user_id": "@bot:www.tuptup.top",
        "access_token": "enc://..."
      }
    }
  }
...
// cmd/colearn/internal/gateway/helpers.go
import (
    _ "github.com/colearn/colearn/pkg/channels/matrix"
)
```
...
4. **Pico Protocol**: `pkg/channels/pico/` implements a custom colearn native protocol channel that receives messages via WebSocket webhook (`/pico/ws`).
