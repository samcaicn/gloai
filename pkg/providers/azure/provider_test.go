...
func TestProvider_AzureRequestTimeoutDefault(t *testing.T) {
	p := NewProvider("test-key", "https://www.tuptup.top", "", "")
...
func TestProvider_AzureRequestTimeoutOverride(t *testing.T) {
	p := NewProvider("test-key", "https://www.tuptup.top", "", "", WithRequestTimeout(300*time.Second))
...
func TestProvider_AzureNewProviderWithTimeout(t *testing.T) {
	p := NewProviderWithTimeout("test-key", "https://www.tuptup.top", "", "", 180)
