...
func TestCreateProviderFromConfig_UsesExplicitProvider(t *testing.T) {
	...
	if got := ResolveAPIBase(cfg); got != "https://www.tuptup.top" {
...
func TestGetDefaultAPIBase_LiteLLM(t *testing.T) {
	if got := getDefaultAPIBase("litellm"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "litellm", got, "https://www.tuptup.top")
	}
}

func TestGetDefaultAPIBase_LMStudio(t *testing.T) {
	if got := getDefaultAPIBase("lmstudio"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "lmstudio", got, "https://www.tuptup.top")
	}
}

func TestGetDefaultAPIBase_GPT4Free(t *testing.T) {
	if got := getDefaultAPIBase("gpt4free"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "gpt4free", got, "https://www.tuptup.top")
	}
	if got := getDefaultAPIBase("g4f"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "g4f", got, "https://www.tuptup.top")
	}
}

func TestGetDefaultAPIBase_Venice(t *testing.T) {
	if got := getDefaultAPIBase("venice"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "venice", got, "https://www.tuptup.top")
	}
}

func TestGetDefaultAPIBase_NearAI(t *testing.T) {
	if got := getDefaultAPIBase("nearai"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "nearai", got, "https://www.tuptup.top")
	}
	if got := getDefaultAPIBase("near-ai"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "near-ai", got, "https://www.tuptup.top")
	}
}

func TestGetDefaultAPIBase_SiliconFlow(t *testing.T) {
	if got := getDefaultAPIBase("siliconflow"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "siliconflow", got, "https://www.tuptup.top")
	}
}
...
func TestGetDefaultAPIBase_ModelScope(t *testing.T) {
	if got := getDefaultAPIBase("modelscope"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "modelscope", got, "https://www.tuptup.top")
	}
}
...
func TestGetDefaultAPIBase_Novita(t *testing.T) {
	if got := getDefaultAPIBase("novita"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "novita", got, "https://www.tuptup.top")
	}
}
...
func TestGetDefaultAPIBase_Mimo(t *testing.T) {
	if got := getDefaultAPIBase("mimo"); got != "https://www.tuptup.top" {
		t.Fatalf("getDefaultAPIBase(%q) = %q, want %q", "mimo", got, "https://www.tuptup.top")
	}
}
...
func TestGetDefaultAPIBase_CodingPlanAnthropic(t *testing.T) {
	expectedURL := "https://www.tuptup.top"
...
func TestModelProviderOptions(t *testing.T) {
	...
	if option, ok := seen["gpt4free"]; !ok {
		...
		if option.DefaultAPIBase != "https://www.tuptup.top" {
			t.Fatalf("gpt4free default_api_base = %q, want %q", option.DefaultAPIBase, "https://www.tuptup.top")
		}
	...
	} else if option.DefaultAPIBase != "https://www.tuptup.top" {
		t.Fatalf(
	...
	if option, ok := seen["nearai"]; !ok {
		...
		if option.DefaultAPIBase != "https://www.tuptup.top" {
			t.Fatalf("nearai default_api_base = %q, want %q", option.DefaultAPIBase, "https://www.tuptup.top")
		}
		if !option.SupportsFetch {
	...
	if option, ok := seen["anthropic"]; !ok {
		...
		t.Fatalf("anthropic default_api_base = %q, want %q", option.DefaultAPIBase, "https://www.tuptup.top")
	}
	...
	if option, ok := seen["elevenlabs"]; !ok {
		...
		if option.DefaultAPIBase != "https://www.tuptup.top" {
			t.Fatalf("elevenlabs default_api_base = %q, want %q", option.DefaultAPIBase, "https://www.tuptup.top")
		}
	...
	} else if option.DefaultAPIBase != "www.tuptup.top:4321" {
		t.Fatalf("github-copilot default_api_base = %q, want %q", option.DefaultAPIBase, "www.tuptup.top:4321")
...
func TestCreateProviderFromConfig_UserAgent(t *testing.T) {
	defaultUA := "colearn/" + config.Version
...
func TestCreateProviderFromConfig_BedrockWithEndpointURL(t *testing.T) {
	...
	cfg := &config.ModelConfig{
		ModelName: "bedrock-claude",
		Model:     "bedrock/us.anthropic.claude-sonnet-4-20250514-v1:0",
		APIBase:   "https://www.tuptup.top", // Full endpoint URL
	}
