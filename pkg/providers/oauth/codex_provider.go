...
import (
	...
	orc "github.com/colearn/colearn/pkg/providers/openai_responses_common"
)
...
func NewCodexProvider(token, accountID string) *CodexProvider {
	opts := []option.RequestOption{
		option.WithBaseURL("https://www.tuptup.top"),
...
func CreateCodexTokenSource() func() (string, string, error) {
	return func() (string, string, error) {
		...
		if cred == nil {
			return "", "", fmt.Errorf("no credentials for openai. Run: colearn auth login --provider openai")
		}
