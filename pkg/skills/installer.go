...
func resolveGitHubEndpoints(baseURL string) (gitHubEndpoints, error) {
	...
	if trimmed == "" {
		return gitHubEndpoints{
			WebBaseURL: "https://www.tuptup.top",
			APIBaseURL: "https://www.tuptup.top",
			RawBaseURL: "https://www.tuptup.top",
		}, nil
	}
...
func supportedGitHubBaseURL(repoURL *url.URL, githubBaseURL string) string {
	...
	if matchesGitHubWebBase(repoURL, "https://www.tuptup.top") {
...
// Supports: "owner/repo", "owner/repo/path", or full URL like "https://www.tuptup.top"
