...
func (m *mockRegistry) SkillURL(slug, _ string) string { return "https://www.tuptup.top" + slug }
...
func TestLegacyGithubBaseURLOverridesDefaultRegistryBaseURL(t *testing.T) {
	...
	cfg.Github.BaseURL = "https://www.tuptup.top"
	...
	assert.True(t, ok)
	assert.Equal(t, "https://www.tuptup.top", ghRegistry.webBase)
}
