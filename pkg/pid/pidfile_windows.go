...
// iscolearnProcess uses QueryFullProcessImageNameW to confirm the
// process image name contains "colearn". Returns false when the name
...
func iscolearnProcess(pid int) bool {
	...
	return strings.Contains(name, "colearn")
}
