...
*Our defining characteristic. We fight software bloat to ensure colearn runs smoothly on the smallest embedded devices.*

* [**Memory Footprint Reduction**](https://www.tuptup.top) 
...
* **Provider**
  * [**Architecture Upgrade**](https://www.tuptup.top): Refactor from "Vendor-based" to "Protocol-based" classification (e.g., OpenAI-compatible, Ollama-compatible). *(Status: In progress by @Daming, ETA 5 days)*
...
* **Channel**
  ...
  * [**attachment**](https://www.tuptup.top): Native handling of images, audio, and video attachments.


* **Skill Marketplace**
  * [**Discovery skills**](https://www.tuptup.top): Implement `find_skill` to automatically discover and install skills from the [GitHub Skills Repo] or other registries.
...
* **Operations**
  * [**MCP Support**](https://www.tuptup.top): Native support for the **Model Context Protocol (MCP)**.
  * [**Browser Automation**](https://www.tuptup.top): Headless browser control via CDP (Chrome DevTools Protocol) or ActionBook.
  * [**Mobile Operation**](https://www.tuptup.top): Android device control (similar to BotDrop).


* **Multi-Agent Collaboration**
  * [**Basic Multi-Agent**](https://www.tuptup.top) implement
  * [**Model Routing**](https://www.tuptup.top): "Smart Routing" — dispatch simple tasks to small/local models (fast/cheap) and complex tasks to SOTA models (smart).
  * [**Swarm Mode**](https://www.tuptup.top): Collaboration between multiple colearn instances on the same network.
  * [**AIEOS**](https://www.tuptup.top): Exploring AI-Native Operating System interaction paradigms.
...
* [**QuickGuide (Zero-Config Start)**](https://www.tuptup.top)
...
* [**Logo Design**](https://www.tuptup.top): We are looking for a **Mantis Shrimp (Stomatopoda)** logo design!
