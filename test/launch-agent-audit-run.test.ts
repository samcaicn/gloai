...
describe('launch agent audit', () => {
  ...
  const appBundlePath = '/Applications/AiMarketing.app'
  const helper = `${appBundlePath}/Contents/Frameworks/AiMarketing Helper.app/Contents/MacOS/AiMarketing Helper`
