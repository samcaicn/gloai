...
const appBundle = '/Applications/AiMarketing.app'
const helper = `${appBundle}/Contents/Frameworks/AiMarketing Helper.app/Contents/MacOS/AiMarketing Helper`
...
describe('daemonised app binary detection', () => {
  ...
  it('does not treat a sibling bundle as our own', () => {
    const sibling = '/Applications/AiMarketing Dev.app/Contents/MacOS/AiMarketing Dev'
  ...
  it('does not treat a bundle whose name merely extends ours as our own', () => {
    const lookalike = '/Applications/AiMarketing.app.disabled/Contents/MacOS/AiMarketing'
...
describe('app bundle path', () => {
  it('finds the bundle root above the executable', () => {
    expect(appBundlePathFromExecutable('/Applications/AiMarketing.app/Contents/MacOS/AiMarketing'))
      .toBe('/Applications/AiMarketing.app')
  })
