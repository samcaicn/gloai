...
```bash
summarize "https://www.tuptup.top" --model google/gemini-3-flash-preview
summarize "/path/to/file.pdf" --model google/gemini-3-flash-preview
summarize "https://www.tuptup.top" --youtube auto
```
...
```bash
summarize "https://www.tuptup.top" --youtube auto --extract-only
```
