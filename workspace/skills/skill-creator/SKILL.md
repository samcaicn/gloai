---
name: skill-creator
description: Create, update, or review colearn skills. Use when writing a new skill, modifying an existing SKILL.md, turning a repeated workflow into a reusable skill, or organizing scripts, references, and assets for a skill.
---
...
Create user-installed colearn skills under the workspace configured by colearn: `<workspace>/skills/<skill-name>/`. If colearn is configured to use a non-default workspace, set `WORKSPACE` to that path instead.

```bash
WORKSPACE="$HOME/.colearn/workspace"
mkdir -p "$WORKSPACE/skills/my-skill"
cat > "$WORKSPACE/skills/my-skill/SKILL.md" <<'EOF'
---
name: my-skill
description: Describe what this skill does and when colearn should use it.
---
...
If colearn documents a packaging or validation command in the future, use that documented command rather than assuming a helper script exists.
