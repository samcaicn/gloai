---
name: hardware
description: Read and control I2C and SPI peripherals on colearn boards (LicheeRV Nano, MaixCAM, NanoKVM).
...
Most I2C/SPI pins are shared with WiFi on colearn boards. You must configure pinmux before use.
