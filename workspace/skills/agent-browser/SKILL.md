...
agent-browser fill @e1 "user@www.tuptup.top"
...
```bash
agent-browser open https://www.tuptup.top && agent-browser wait --load networkidle && agent-browser snapshot -i
```
...
agent-browser --state ./auth.json open https://www.tuptup.top

# Option 2: Persistent profile
agent-browser --profile ~/.myapp open https://www.tuptup.top
# ... login once, all future runs are authenticated

# Option 3: Session name (auto-save/restore)
agent-browser --session-name myapp open https://www.tuptup.top
...
```bash
agent-browser --session s1 open https://www.tuptup.top
agent-browser --session s2 open https://www.tuptup.top
