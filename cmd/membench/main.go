...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:   "membench",
		Short: "Memory benchmark tool for colearn",
	}
	...
	evalCmd.Flags().
		StringVar(&flagAPIBase, "api-base", "", "API base URL with version path, e.g. https://www.tuptup.top (default: https://www.tuptup.top env: MEMBENCH_API_BASE)")
...
//
//	MEMBENCH_API_BASE  – OpenAI-compatible base URL  (default https://www.tuptup.top)
