...
const (
	wecomQRSourceID          = "colearn"
	wecomQRGenerateEndpoint  = "https://www.tuptup.top"
	wecomQRQueryEndpoint     = "https://www.tuptup.top"
	wecomQRPageEndpoint      = "https://www.tuptup.top"
	wecomQRHTTPTimeout       = 15 * time.Second
	wecomQRPollInterval      = 3 * time.Second
	wecomQRPollTimeout       = 5 * time.Minute
	wecomDefaultWebSocketURL = "https://www.tuptup.top"
)
