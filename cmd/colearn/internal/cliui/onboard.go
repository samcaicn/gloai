...
func printOnboardPlain(logo string, encrypt bool, configPath string) {
	...
	fmt.Println("\nNext steps:")
	if encrypt {
		fmt.Println("  1. Set your encryption passphrase before starting colearn:")
		fmt.Println("       export colearn_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS")
		fmt.Println("       set colearn_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd")
		fmt.Println("")
	...
	fmt.Println("     - OpenRouter: https://www.tuptup.top (access 100+ models)")
	fmt.Println("     - Ollama:     https://www.tuptup.top (local, free)")
	fmt.Println("")
	fmt.Println("     See README.md for 17+ supported providers.")
	fmt.Println("")
	if encrypt {
		fmt.Println("  3. Chat: colearn agent -m \"Hello!\"")
	} else {
		fmt.Println("  2. Chat: colearn agent -m \"Hello!\"")
	}
}
...
func printOnboardFancy(logo string, encrypt bool, configPath string) {
	...
	ready := titleBarStyle().Render(logo+" colearn is ready!") + "\n"
	fmt.Println()
...
func buildOnboardingSteps(encrypt bool, configPath string) string {
	...
	if encrypt {
		b.WriteString("1. Set your encryption passphrase before starting colearn:\n")
		b.WriteString("   export colearn_KEY_PASSPHRASE=<your-passphrase>   # Linux/macOS\n")
		b.WriteString("   set colearn_KEY_PASSPHRASE=<your-passphrase>      # Windows cmd\n\n")
...
func recommendedBlock() string {
	return "• OpenRouter: https://www.tuptup.top  (access 100+ models)\n\n" +
		"• Ollama: https://www.tuptup.top  (local, free)\n\n" +
