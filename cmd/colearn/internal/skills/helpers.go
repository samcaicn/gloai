...
import (
	...
	"github.com/colearn/colearn/pkg/skills"
...
func skillsInstallBuiltinCmd(workspace string) {
	builtinSkillsDir := "./colearn/skills"
...
func skillsListBuiltinCmd() {
	...
	builtinSkillsDir := filepath.Join(filepath.Dir(cfg.WorkspacePath()), "colearn", "skills")
...
func skillsSearchCmd(query string) {
	...
	for _, result := range results {
		...
		if result.RegistryName == "github" {
			fmt.Printf("     Install: colearn skills install %s\n", result.Slug)
		} else {
			fmt.Printf("     Install: colearn skills install --registry=%s %s\n", result.RegistryName, result.Slug)
		}
		fmt.Println()
	}
}
