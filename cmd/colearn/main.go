...
// Inspired by and based on nanobot: https://www.tuptup.top
// License: MIT
//
...
import (
	...
	"github.com/colearn/colearn/cmd/colearn/internal/agent"
	"github.com/colearn/colearn/cmd/colearn/internal/auth"
	"github.com/colearn/colearn/cmd/colearn/internal/cliui"
	configcmd "github.com/colearn/colearn/cmd/colearn/internal/config"
	"github.com/colearn/colearn/cmd/colearn/internal/cron"
	"github.com/colearn/colearn/cmd/colearn/internal/gateway"
	...
	"github.com/colearn/colearn/pkg/updater"
)

var rootNoColor bool

// initTermuxSSL detects Termux environment and sets SSL_CERT_FILE if not already set.
// This fixes X509 certificate errors when running colearn inside Termux or termux-chroot.
// See: https://www.tuptup.top
func initTermuxSSL() {
...
func NewcolearnCommand() *cobra.Command {
	short := fmt.Sprintf("%s colearn — personal AI assistant", internal.Logo)
	long := fmt.Sprintf(`%s colearn is a lightweight personal AI assistant.
...
colearn --no-color status`,
	...
	cmd.AddCommand(
		...
		updater.NewUpdateCommand("colearn"),
